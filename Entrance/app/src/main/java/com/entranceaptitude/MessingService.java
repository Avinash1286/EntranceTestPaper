...
public class MessingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String notificationTitle, String notificationBody) {
        ...
        Bitmap picture= BitmapFactory.decodeResource(getResources(),R.drawable.ex);
        NotificationCompat.Builder builder=new NotificationCompat.Builder(MessingService.this);
        builder.setLargeIcon(BitmapFactory.decodeResource(getResources(),R.drawable.ex));
        ...
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            CharSequence name="Entrance Exam 2020";
            String description="Includes all Entrance Exam notification";
